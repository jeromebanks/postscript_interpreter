...
| Infinite Descent | `infinite_descent.ps` | A Poincaré-disk {7,3} hyperbolic tessellation (artkit's `httile`) — one heptagon reflected across its own edges out to four generations, 233 tiles colored in rings by generation |
